...
################################################################################
## Form generated from reading UI file 'add_chirpeRRyLc.ui'
##
...
class Ui_AddChirp(object):
    def setupUi(self, AddChirp):
        ...
        self.gridLayout.addWidget(self.text_output_list_of_points, 8, 4, 2, 1)

        self.listView = QListView(AddChirp)
        self.listView.setObjectName(u"listView")

        self.gridLayout.addWidget(self.listView, 8, 3, 2, 1)
        ...
        QWidget.setTabOrder(self.button_plot, self.text_output_list_of_points)
