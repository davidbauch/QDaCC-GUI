...
################################################################################
## Form generated from reading UI file 'add_pulseCMJANJ.ui'
##
...
"QScrollBar::add-page:vertical, QScrollBar::sub-page:vertical {background: none;}")
        ...
        self.button_cancel = QPushButton(AddPulse)
        self.button_cancel.setObjectName(u"button_cancel")
        self.button_cancel.setGeometry(QRect(260, 500, 120, 36))
    ...
    def retranslateUi(self, AddPulse):
        ...
        self.button_confirm.setText(QCoreApplication.translate("AddPulse", u"Confirm", None))
        self.button_cancel.setText(QCoreApplication.translate("AddPulse", u"Cancel", None))
        ...
        self.textinput_type.setText(QCoreApplication.translate("AddPulse", u"gauss", None))
